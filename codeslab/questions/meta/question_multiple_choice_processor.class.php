 ...
 * @version 0.9
 */
class QuestionMultipleChoiceProcessor extends QuestionBaseProcessor {
    ...
    public function defineStyles() {
        ...
        $this->qop = array($this->qnp, $this->qtp, '?', '((?=', $this->qnp, ')|(?=', QuestionType::$PATTERNS[QuestionType::MULTIPLE_CHOICE], '))'); // question & option pattern
    }
